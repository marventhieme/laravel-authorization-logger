...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-authorization-logger.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-authorization-logger)
...
```bash
php artisan vendor:publish --tag="laravel-authorization-logger-views"
```

## Usage

```php
$laravelAuthorizationLogger = new MarvenThieme\LaravelAuthorizationLogger();
echo $laravelAuthorizationLogger->echoPhrase('Hello, Marven Thieme!');
```
